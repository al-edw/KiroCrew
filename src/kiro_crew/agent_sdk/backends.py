...
.. list-table::
   ...
   * - ``ACP_BACKENDS_MARKDOWN_AGENT_SPECS``
     - driver-internal (whether the host loads the markdown agent form, so a
       markdown-only agent may be spawned at all; the runtime's pre-spawn gate
       reads it through the harness)
