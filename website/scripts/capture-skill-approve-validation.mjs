...
try {
  ...
  await page
    .getByText('Approval refused: the bundled scripts failed validation — fix the scripts, then approve again.')
    .first()
    .waitFor()
  ...
  await page
    .getByText('Approval of “auto/rotate-staging-fixtures” failed: this candidate is no longer pending — it was approved or dismissed elsewhere.', { exact: true })
    .first()
    .waitFor()
